...
#+begin_src emacs-lisp
  (defun recker/org-jump (file heading)
    ...
    (interactive "fFile: \nsHeading: ")
    (message "Jumping to %s::%s" file heading)
    (find-file file)
    (beginning-of-buffer)
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-agenda-custom-commands '("oi" "writing ideas" tags-todo "+writing"))
  (add-to-list 'org-agenda-custom-commands '("ow" "work tasks" tags-todo "+work"))
  (add-to-list 'org-agenda-custom-commands '("op" "productivity tasks" tags-todo "+productivity"))
...
| op | productivity tasks | tags-todo                                | +productivity |
| ow | work tasks         | tags-todo                                | +work         |
| oi | writing ideas      | tags-todo                                | +writing      |
...
#+RESULTS:
| nnimap | alex@reckerfamily.com | (nnimap-address imap.gmail.com) | (nnimap-server-port imaps) | (nnimap-stream ssl) | (nnmail-expiry-target nnimap+gmail:[Gmail]/Trash) | (nnmail-expiry-wait immediate) |
