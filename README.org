...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-capture-templates
               `("m" "mixtape notes" plain (file+olp+datetree ,(recker/path 'docs "opsat.org") "Mixtape") nil
                 :empty-lines-before 1 :empty-lines-after 1))

  (add-to-list 'org-capture-templates
               `("i" "idea" plain (file+olp+datetree ,(recker/path 'docs "opsat.org") "Ideas") nil
                 :empty-lines-before 1 :empty-lines-after 1))
...
#+RESULTS:
| t | triage            | entry | (file+headline /home/alex/docs/opsat.org Triage)       | * TODO %? |                     |   |                    |   |
| w | work task         | entry | (file+headline /home/alex/docs/opsat.org Work)         | * TODO %? |                     |   |                    |   |
| p | productivity task | entry | (file+headline /home/alex/docs/opsat.org Productivity) | * TODO %? |                     |   |                    |   |
| i | idea              | plain | (file+olp+datetree /home/alex/docs/opsat.org Ideas)    | nil       | :empty-lines-before | 1 | :empty-lines-after | 1 |
| m | mixtape notes     | plain | (file+olp+datetree /home/alex/docs/opsat.org Mixtape)  | nil       | :empty-lines-before | 1 | :empty-lines-after | 1 |
| j | journal entry     | plain | (file+olp+datetree /home/alex/docs/opsat.org Journal)  | nil       | :empty-lines-before | 1 | :empty-lines-after | 1 |
| o | opsat topic       | entry | (file /home/alex/docs/opsat.org)                       | * %?      |                     |   |                    |   |
...
Custom agenda commands (if I ever end up using these).

#+begin_src emacs-lisp
  (setq org-agenda-custom-commands '())

  (setq recker/tag-agenda-todos
        '("work" "triage" "resolutions" "productivity" "grandpa"))

  (dolist (tag recker/tag-agenda-todos)
    (add-to-list 'org-agenda-custom-commands `(,(nth 1 (split-string tag "")) ,tag tags-todo ,tag)))
#+end_src
...
#+RESULTS:
| nnimap | arecker@zendesk.com   | (nnimap-user arecker@zendesk.com) | (nnimap-address imap.gmail.com) | (nnimap-server-port imaps) | (nnimap-stream ssl)                                                  | (nnmail-expiry-target nnimap+arecker@zendesk.com:[Gmail]/All Mail) | (nnmail-expiry-wait immediate) |
| nnimap | alex@reckerfamily.com | (nnimap-address imap.gmail.com)   | (nnimap-server-port imaps)      | (nnimap-stream ssl)        | (nnmail-expiry-target nnimap+alex@reckerfamily.com:[Gmail]/All Mail) | (nnmail-expiry-wait immediate)                                     |                                |
