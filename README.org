...
I don't use the toolbar.  I just enjoy the silly icons.
...
#+BEGIN_SRC emacs-lisp
  (setq ispell-personal-dictionary "~/docs/ispell.dict")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (setq gnus-home-directory "~/docs/gnus"
	...
	gnus-cache-directory "~/docs/gnus/cache")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (setq tetris-score-file "~/docs/games/tetris-scores")
#+END_SRC
