...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-capture-templates
               `("j" "journal entry" plain (file+olp+datetree ,(recker/path 'docs "opsat.org") "Journal") "%?\n"
                 :empty-lines-before 1 :empty-lines-after 1))

  (add-to-list 'org-capture-templates
               `("m" "mixtape notes" plain (file+olp+datetree ,(recker/path 'docs "opsat.org") "Mixtape") "%?\n"
                 :empty-lines-before 1 :empty-lines-after 1))

  (add-to-list 'org-capture-templates
               `("i" "idea" plain (file+olp+datetree ,(recker/path 'docs "opsat.org") "Ideas") "%?\n"
                 :empty-lines-before 1 :empty-lines-after 1))
