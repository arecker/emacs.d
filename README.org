...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-capture-templates
               `("w" "writing idea" entry (file+headline ,(recker/path 'docs "opsat.org") "Writing") "* TODO %?\n"))
...
| w | writing idea         | entry     | (file+headline /home/alex/docs/opsat.org Writing)     | * TODO %? |
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-agenda-custom-commands '("ow" "writing ideas" tags-todo "+writing"))
...
| ow | writing ideas | tags-todo                                | +writing |
