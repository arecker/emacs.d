...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-capture-templates
               `("m" "mixtape notes" plain (file+headline ,(recker/path 'docs "opsat.org") "Mixtape") nil :empty-lines 1))
...
| :empty-lines | 1                    |           |                                                   |           |              |   |
| m            | mixtape notes        | plain     | (file+headline /home/alex/docs/opsat.org Mixtape) | nil       | :empty-lines | 1 |
...
#+begin_src emacs-lisp
  (setq org-agenda-custom-commands '())
  (add-to-list 'org-agenda-custom-commands '("w" tags-todo "+writing"))
#+end_src
