...
* Gnus
  ...
  This is basically a "blank" gnus.  Setting the primary method as
  =nnml ""= is just a way for you to open the program and poke around.

  #+BEGIN_SRC emacs-lisp
    (setq gnus-select-method '(nnml "")
          message-directory "~/org/.mail"
          gnus-directory "~/org/.news"
          nnfolder-directory "~/org/.mail/archive"
