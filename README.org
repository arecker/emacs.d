...
#+BEGIN_SRC emacs-lisp
  ...
  (setq recker/active-password-store (expand-file-name "~/.password-store"))

  (defun password-store-dir ()
    recker/active-password-store)

  (defun recker/password-store-copy-work ()
    (interactive)
    (let ((recker/active-password-store (expand-file-name "~/.password-store-work")))
