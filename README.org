...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-capture-templates
               `("i" "writing idea" entry (file+olp+datetree ,(recker/path 'docs "opsat.org") "Writing") nil))
...
#+RESULTS:
| t | to-do item for today | checkitem | (file+headline /home/alex/docs/opsat.org Today)        |           |
...
| i | writing idea         | entry     | (file+olp+datetree /home/alex/docs/opsat.org Writing)  | nil       |
| m | mixtape notes        | plain     | (file+olp+datetree /home/alex/docs/opsat.org Mixtape)  | nil       |
| j | journal entry        | plain     | (file+olp+datetree /home/alex/docs/opsat.org Journal)  | nil       |
